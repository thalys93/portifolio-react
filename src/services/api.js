...
export const apiField = async () => {
    try{
        const response = await axios.get('https://26.79.95.70:1337/api/projetos?fields[0]');
...
export const apiProjects = async () => {
    try{
        const response  = await axios.get("https://26.79.95.70:1337/api/projetos?populate=*")
        return response.data
    }catch(error){
        console.error('Falha ao buscar Dados na Api', error);
        throw error;
...
export const apiId = async (id) => {
    try{
        const response = await axios.get(`https://26.79.95.70:1337/api/projetos/${id}?populate=*`)
        return response.data
    }catch(error){
        console.error('Falha ao buscar Dados na Api', error);
        throw error;
